...
(
  ...
  /usr/bin/curl -q --proto '=https' --tlsv1.2 -fsSL \
    'https://raw.githubusercontent.com/DanielArcidiacono/Poker/v1.2.0/scripts/bootstrap.sh' \
    -o "$installer" &&
  /bin/bash "$installer"
)
```
...
try {
  ...
  try {
    $Client.DownloadFile(
      "https://raw.githubusercontent.com/DanielArcidiacono/Poker/v1.2.0/windows/bootstrap.ps1",
      $Installer
    )
  } finally {
    $Client.Dispose()
